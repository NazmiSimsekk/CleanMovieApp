...
import com.simsek.cleanmovieapp.domain.use_case.get_movie_detail.GetMovieDetailsUseCase
...
class MovieDetailViewModel @Inject constructor(
    ...
    private fun getMovieDetail(imdbId: String) {
         getMovieDetailUseCase.executeGetMovieDetails(imdbId).onEach {
             when(it) {
                 is Resource.Error -> {
                     _state.value = MovieDetailState(error = it.message ?: "Error MovieDetailViewModel")
                 }
